...
const SCHEDULES = {
  '2026-04-19': [
    { time: '10:00 AM', buyer: 'Chen family', title: 'Tampines Trilliant', detail: '#05-11 · Rachel Ng', tone: 'confirmed' },
    { time: '10:30 AM', buyer: 'Chen family', title: 'Tampines Court', detail: '#12-08 · Kenneth Soh', tone: 'confirmed' },
    { time: '11:45 AM', buyer: 'Chen family', title: 'Bedok Grove', detail: '#03-05 · James Wong', tone: 'confirmed' },
  ],
  '2026-04-20': [
    { time: '7:00 PM', buyer: 'Chen family', title: 'Queenstown View', detail: '#03-08 · Priya Menon', tone: 'confirmed' },
    { time: '7:45 PM', buyer: 'Chen family', title: 'Commonwealth Towers', detail: '#18-04 · Daniel Koh', tone: 'confirmed' },
  ],
  '2026-04-22': [
    { time: '2:30 PM', buyer: 'Hazel Koh', title: 'Follow-up buffer', detail: 'Hold for owner confirmation · Queenstown cluster', tone: 'hold' },
  ],
  '2026-04-24': [
    { time: '11:00 AM', buyer: 'Ng family', title: 'Shortlist review call', detail: '30 min planning block', tone: 'pending' },
  ],
};
...
export default function Schedule() {
  ...
  const calendarDays = useMemo(() => buildMonthDays(), []);
  const selectedEvents = SCHEDULES[selectedDate] || [];
