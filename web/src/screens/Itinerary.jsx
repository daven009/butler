      ...
      <div className="screen-body">
        <div style={{ padding: '18px 20px 0' }}>
          <div style={{ background: AB.white, borderRadius: 18, padding: '18px', border: `1px solid ${AB.border}` }}>
            <div className="section-label">Chen family · 3BR rental</div>
            <div style={{ fontFamily: '"Playfair Display", Georgia, serif', fontSize: 24, fontWeight: 600, letterSpacing: -0.3, marginTop: 4 }}>Sat 19 — Sun 20 Apr</div>
            <div style={{ fontSize: 13, color: AB.gray, marginTop: 2 }}>6 viewings · 2 days · across 3 neighbourhoods</div>
        ...
        <div style={{ padding: '16px 20px 0' }}>
          <div style={{ fontFamily: '"Playfair Display", Georgia, serif', fontSize: 19, fontWeight: 600, marginBottom: 8 }}>Saturday · 19 April</div>
          <div style={{ background: AB.white, borderRadius: 16, overflow: 'hidden', border: `1px solid ${AB.border}` }}>
            <StopRow time="10:00" ampm="AM" address="Tampines Trilliant" unit="#05-11" agent="Rachel Ng" tags={['✓ Pet-friendly', 'Tampines MRT 4min']} first />
            <StopRow time="10:30" ampm="AM" address="Tampines Court" unit="#12-08" agent="Kenneth Soh" tags={['Extra store']} transit="walk · 3 min" />
            <StopRow time="11:15" ampm="AM" address="Bedok Residences" unit="#09-22" agent="Sarah Lim" tags={['High floor']} transit="drive · 15 min · PIE→ECP" />
            <StopRow time="11:45" ampm="AM" address="Bedok Grove" unit="#03-05" agent="James Wong" tags={['✓ Private garden']} transit="walk · 4 min" />
          </div>
        </div>

        <div style={{ padding: '16px 20px 0' }}>
          <div style={{ fontFamily: '"Playfair Display", Georgia, serif', fontSize: 19, fontWeight: 600, marginBottom: 8 }}>Sunday · 20 April</div>
          <div style={{ background: AB.white, borderRadius: 16, overflow: 'hidden', border: `1px solid ${AB.border}` }}>
            <StopRow time="7:00" ampm="PM" address="Queenstown View" unit="#03-08" agent="Priya Menon" tags={['✓ Nanyang Pri 1km']} first />
            <StopRow time="7:45" ampm="PM" address="Commonwealth Towers" unit="#18-04" agent="Daniel Koh" tags={['Pool view']} transit="walk · 6 min" />
          </div>
        </div>
        ...
        <div style={{ padding: '20px 20px 12px' }}>
          ...
          <button type="button" style={{ ...outlineButton, width: '100%', marginTop: 10 }}>Export as PDF</button>
        </div>
      </div>
